...
-- ) ENGINE=InnoDB
--
-- Delete all people whose age is NULL. Then, list all such rows which still
-- satisfy the criteria. -- 14 points

DELETE FROM bsg_people WHERE age=NULL;
SELECT * FROM bsg_people WHERE age=NULL;
